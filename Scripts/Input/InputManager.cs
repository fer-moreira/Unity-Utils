    ...
    public class InputReader
    {
        ...
        public static bool GetButtonDown(string inputName, InputActionAsset inputActionAsset = null)
        {
            ...
            if (inputActionAsset == null)
                inputActionAsset = InputManager.instance.inputActionAsset;
        ...
        {
            //return InputManager.instance.playerInput.currentControlScheme == InputManager.instance.inputActionAsset.FindControlScheme(controlSchemeName).Value.name
